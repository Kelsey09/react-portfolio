...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://kelseydurmeier.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://kelseydurmeier.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
                        ...
                        {this.state.thumb_image_url && this.state.editMode ? (
                            <div className="portfolio-manager-image-wrapper">
                                ...
                                <div className="image-removal-link">
                                    <a onClick={() => this.deleteImage("thumnb_image")}>
                                        Remove Thumbnail
                                    </a>
                                </div>
                            </div>
